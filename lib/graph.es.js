import {has,constant,isFunction,keys,filter,isEmpty,each,isUndefined,union,reduce,isObject,map,toString} from "./ported-lodash.js";
...
function makeWriter(INDENT = "") {
  ...
  if (g.graph() !== undefined) {
    json.value = Object.assign({}, g.graph())
    // _.clone(g.graph()); //e w, leaky
  }
  return json;
}
...
export{Graph, read as readJSON, writeDot, write as writeJSON};